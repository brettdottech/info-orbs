...
**Version 1.1 of the firmware is here, you can find the new features [outlined below](#version-1.1-release). If you're coming from Youtube, the software flashing instructions have changed slightly, please refer to the NEW FLASHING INSTRUCTIONS to ensure you get up and running smoothly.**
...
**1.1 Changes:**
 ...
 10. MQTT widget introduced to display data from and MQTT broker, with a home assistant blueprint available.  
