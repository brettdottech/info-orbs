...
#define TIMEZONE_API_LOCATION "America/Denver" // Use timezone from this list: https://timezonedb.com/time-zones
#define WEATHER_LOCAION "Orem, UT" //city/state for the weather
#define STOCK_TICKER_LIST "SPY,VT,GOOG,TSLA,GME" // Choose your 5 stocks to display on the stock tracker
...
// No longer used with change to WiFiManager.
