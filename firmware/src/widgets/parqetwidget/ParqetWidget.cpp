...
ParqetWidget::ParqetWidget(ScreenManager &manager, ConfigManager &config) : Widget(manager, config) {
    ...
    m_config.addConfigComboBox("ParqetWidget", "showClock", &m_defaultMode, m_modes, PARQET_MODE_COUNT, "Default timeframe (you can change timeframes by medium pressing the middle button)");
    ...
    m_config.addConfigComboBox("ParqetWidget", "showValues", &m_showValues, optPriceVal, 2, "Show price or value for stocks");
